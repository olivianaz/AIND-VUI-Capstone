...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    bn_rnn = BatchNormalization(name="bn_1")(rnn)
    for i in range(1, recur_layers):
        rnn = GRU(units, activation='relu',
                         return_sequences=True, implementation=2, name="rnn_{}".format(i+1))(bn_rnn)
        bn_rnn = BatchNormalization(name="bn_{}".format(i+1))(rnn)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
    time_dense = TimeDistributed(Dense(output_dim))(bn_rnn)
    # Add softmax activation layer
    y_pred = Activation('softmax', name='softmax')(time_dense)
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu', implementation=2, return_sequences=True), merge_mode="concat")(input_data)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
